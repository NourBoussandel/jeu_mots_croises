...
(function($){
	...
	$.fn.crossword = function(entryData) {
			...
			*/
			...
			this.after('<div id="puzzle-clues"><h2>Across</h2><ol id="across"></ol><h2>Down</h2><ol id="down" start="10"></ol></div>');
			...
			function triggerCountdown(){
                ...
                countdownID = setInterval(()=> {
					...
					clearInterval(countdownID);
				    window.open("paragrapheweb.html")*/
			    ...
			    let inputString = document.querySelector('#puzzle-wrapper')
				let body = document.querySelector('#puzzle-wrapper')
			function gameOver(){
				window.location.replace('paragrapheweb.html')
				clearInterval(countdownID)
				body.style.backdropFilter = 'blur(100px)'
				inputString.innerHTML = '<h1>GAME OVER</h1>'
